...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Mayo Hospital </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left,#de3b95, #ff0000c2);
}
.list-group-item.active {
    z-index: 2;
    color: #fff;
    background-color: #de3b94;
    border-color: #007bff;
}
.text-primary {
    color: #de3b94!important;
}
  </style>
